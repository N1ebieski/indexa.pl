            ...
            <div class="col pl-lg-0 order-2">
                <div class="rounded text-{{ $dir->group->border ?? null }} tlo-{{ $dir->group->border ?? null }}">
					...
					<small class="mr-auto">
                        ...
                        <small class="ml-auto">&nbsp;&nbsp;<b>{{ $dir->sum_rating }}</b>
                    ...
                    <h1 class="h3 tytul-{{ $dir->group->border ?? null }}">
                        <a href="{{ $dir->url }}" class="header-anchor" rel="" title="{{ $dir->title }}" target="_blank"> {{ $dir->title }}</a>
                    </h1>
                    <ul class="list-inline text-sm mb-4 stats">
                        ...
                        @endif
                        @endif
                        <li class="list-inline-item mr-3">ID: {{ $dir->id }}</li>
                    </ul>
                    ...
                    <div class="d-flex">
                        <div class="ml-auto">
@if ($dir->url !== null)
                    <div class="text-primary"><i class="fas fa-play"></i>&nbsp;{!! $dir->url_as_link !!}</div>
                    @endif
                    ...
                    <h4 class="h5 mb-4 mb-4 "><i class="far fa-folder"></i>&nbsp;{{ trans('icore::categories.categories.label') }}</h4>
                    <ul class="amenities-list list-inline text-{{ $dir->group->border ?? null }}">
                    ...
                    <h4 class="h5 mb-4 mb-4"><i class="fa fa-hashtag"></i>&nbsp;{{ trans('idir::dirs.tags.label') }}</h4>
            ...
            <div class="col-12 col-lg-4 text-md-left text-center order-1 ">
                <div class="shadow">
                    @if ($dir->url !== null)
                    <div class="">
                        <a href="{{ $dir->url }}" rel="" title="{{ $dir->title }}" target="_blank"> <img src="{{ $dir->thumbnail_url }}" class="img-fluid mx-auto d-block rounded " alt="{{ $dir->title }}"></a>
                    </div>
                    <div class="kontener-{{ $dir->group->border ?? null }}">
                        <div class="grupa-{{ $dir->group->border ?? null }} outline-{{ $dir->group->border ?? null }}">{{ $dir->group->border ?? null }}</div>
                    </div>
                    @endif
